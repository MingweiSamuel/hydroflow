...
<CodeBlock language="rust" title="flow/src/first_ten.rs">{getLines(firstTenSrc, 'flowgraph_sig')}</CodeBlock>
...
<CodeBlock language="rust">{getLines(firstTenSrc, 'process')}</CodeBlock>
...
<CodeBlock language="rust">{getLines(firstTenSrc, 'numbers')}</CodeBlock>
...
<CodeBlock language="rust">{getLines(firstTenSrc, 'foreach')}</CodeBlock>
...
<CodeBlock language="rust" title="flow/src/first_ten.rs">{getLines(firstTenSrc, 'runtime')}</CodeBlock>
