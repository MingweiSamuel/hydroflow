...
push its generated commits to `main`. This can leave the repo in a bit of a half-broken state in
terms of releases. The job should've pushed some commit with a bunch of version tags and you will
(probably) need to hard-reset main to point to that tagged commit instead. You might also need to
manually create [GitHub releases](https://github.com/hydro-project/hydroflow/releases), I don't
remember.
