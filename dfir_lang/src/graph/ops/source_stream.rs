...
use super::{
    Boundedness, FloType, OperatorCategory, OperatorConstraints, OperatorWriteOutput, WriteContextArgs, RANGE_0,
    RANGE_1,
};
...
pub const SOURCE_STREAM: OperatorConstraints = OperatorConstraints {
    ...
    flag_output_boundedness: |_| vec![Boundedness::Unbounded], // Output is unbounded (stream can produce indefinitely)
