...
impl Hydroflow {
    ...
    pub fn tick(&mut self) {
        while self.tick_stratum() {}
    }

    /// Runs one stratum of the dataflow until no more work is immediately available.
    /// Return true if more work is available on other strata, otherwise false if no work is immediately available.
    pub fn tick_stratum(&mut self) -> bool {
